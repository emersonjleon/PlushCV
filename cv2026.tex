...
\descript{| Math Education | AI Olympiads}
\location{April 2024 – today| Bogotá , Colombia}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
\sectionsep
\item Researcher Profesor at Doctoral Studies of Math Education
\item Organizer of the Colombian Olympiad in Artificial Inteligence and Team Leader of Colombia in international competitions IOAI  
\item Skills: teaching · math  · artificial intelligence · python  · pandas · sklearn · pytorch · html 
\end{tightemize}
\sectionsep
...
\begin{tightemize}
\sectionsep
\item Grant from \emph{Idartes} for art, science and technology with \emph{Tercer Piso Danza}
...
\item Skills and tools: web development· arts and science · python · openAI · flask · django · javaScript  · artificial intelligence · three.js 
\end{tightemize}
\sectionsep
...
\begin{tightemize}
  %\item T
\item Tuition reimbursement due to top grades each semester.\\
\item Honors degree
\end{tightemize}
